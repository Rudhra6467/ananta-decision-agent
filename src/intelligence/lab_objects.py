...
LAW = (
    ...
    "Lab recommendation ≠ TAKE. Health sweep ≠ CFG row. Date-phase tags ≠ similarity engine."
)
...
OBJECTS = {
    ...
    "EVIDENCE_LIBRARY": "knowledge_grid + evidence_desk + episode_tag — queryable; SUITABLE=0",
}

NOT_NOW = (
    "similarity / chart-lookalike episodes",
    "evidence decay",
    "50 more strategies",
    "LLM price",
...
BLOCKED = (
    ...
    "EP-2021-22: Ananta warehouse starts 2025-06-28."
)
